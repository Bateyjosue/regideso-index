  ...
  return (
    <>
      ...
      >
        ...
        {/* Navigation */}
        <nav className="flex-1 overflow-y-auto px-4 pb-4 scrollbar-thin scrollbar-thumb-gray">
          {/* Main Menu */}
          <div className="mb-8">
            ...
            <ul className="space-y-1">
              {menuItems.map((item, index) => (
                <li key={index}>
                  ...
                  >
                    <div className={`${pathname === item.path ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300'}`}>
                      {item.icon}
                    </div>
                ...
                >
                  {(handleClick, open) => (
                    <>
                      ...
                      >
                        <div className={`${pathname === item.path || pathname.includes(item.path) ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300'}`}>
                          {item.icon}
                        </div>
                        ...
                        <svg
                          className={`h-4 w-4 transition-transform duration-200 ${
                            open ? 'rotate-180' : ''
                          } ${pathname === item.path || pathname.includes(item.path) ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400'}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
              ...
              {systemItems.map((item, index) => (
                <li key={index}>
                  ...
                  >
                    ...
                    <span>{item.title}</span>
                    {item.badge && (
                      <span className="ml-auto rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-200">
                        {item.badge}
                      </span>
                    )}
                  </NavLink>
